...
#Looking at cluster group 8
df_8=pd.read_csv("C:/Egyetem/Szakmai_gyak/Data_tables/clustered_r.csv", sep=";")
df_8.head(5)
df_8.loc[df_8.ClustGroup == 8, "Status"]="1"
df_8.loc[df_8.ClustGroup != 8 , "Status"]= "0"

df_8.to_csv("C:/Egyetem/Szakmai_gyak/Data_tables/df_6.csv", sep=";")

#Looking at cluster group 7
df_7=pd.read_csv("C:/Egyetem/Szakmai_gyak/Data_tables/clustered_r.csv", sep=";")
df_7.head(5)
df_7.loc[df_7.ClustGroup == 7, "Status"]="1"
df_7.loc[df_7.ClustGroup != 7 , "Status"]= "0"

df_7.to_csv("C:/Egyetem/Szakmai_gyak/Data_tables/df_6.csv", sep=";")
...
df_5.to_csv("C:/Egyetem/Szakmai_gyak/Data_tables/variance_analysis/df_5.csv", sep=";")
...
df_4.to_csv("C:/Egyetem/Szakmai_gyak/Data_tables/variance_analysis/df_4.csv", sep=";")
...
df_3.to_csv("C:/Egyetem/Szakmai_gyak/Data_tables/variance_analysis/df_3.csv", sep=";")
...
df_2.to_csv("C:/Egyetem/Szakmai_gyak/Data_tables/variance_analysis/df_2.csv", sep=";")
...
df_1.to_csv("C:/Egyetem/Szakmai_gyak/Data_tables/variance_analysis/df_1.csv", sep=";")